...
-- This includes main comments, threaded replies, and reactions (likes)
...
-- INSERT INTO public.comments (match_id, user_id, comment_text, parent_comment_id) VALUES 
-- (1, 1, 'This is a main comment', NULL),
-- (1, 2, 'This is a reply to the main comment', 1),
-- (1, 3, 'This is another reply to the main comment', 1);
